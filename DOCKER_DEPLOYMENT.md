# Docker Deployment Guide for Bell-Timer
...
3. Connect your GitHub repository `suvro2711/Bell-Timer`
4. Configure:
   - **Name**: bell-timer
   - **Environment**: Docker
...
Your app will be live at: `https://bell-timer-<random>.onrender.com`
